...
class gros extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<gros> {

  ScrollController controller = ScrollController();
  bool closeTopContainer = false;
  double topContainer = 0;
  final Stream<QuerySnapshot> serv = FirebaseFirestore.instance.collection('gros').snapshots();
  CollectionReference gros =FirebaseFirestore.instance.collection('gros');
  double total=0;
  bool active=false;
  Future<bool> button()async{
    var responce=await gros.where('count',isGreaterThan: 0).get();
                                                          ...
                                                          child: Container(alignment: Alignment.center,
                                                              ...
                                                              child: IconButton(
                                                                  onPressed: ()async{
                                                                    ...
                                                                    setState(() {
                                                                      if(service['count']>0){
                                                                        FirebaseFirestore.instance.collection("gros").doc(service.id).update(
                                                                            {
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                            ...
                            var get=await gros.where('count',isGreaterThan: 0).get();
                            ...
                            responce.docs.forEach((element) {
                              ...
                              FirebaseFirestore.instance.collection('gros').doc(element.id).update(
                                  {
                                    'count':0,
                                    'total':0,
                        ...
                        MaterialButton(
                          ...
                          textColor: Colors.white,
                          onPressed:() async{
                              FirebaseFirestore.instance.collection('gros').where('count' ,isGreaterThan: 0).get().then((value) {
                            ...
                            var sup = await FirebaseFirestore.instance.collection('facture').where('desc',isEqualTo: "gros").get();
