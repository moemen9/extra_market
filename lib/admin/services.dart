...
import 'package:extra_market/admin/modif_service.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:jiffy/jiffy.dart';

import 'ajouter_serv.dart';
    ...
    return Scaffold(
      ...
      Container(
          ...
          Column(children: [
            ...
            GestureDetector(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder:((context) => ajout_serv() )));
              },
              child: Container(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: StreamBuilder<QuerySnapshot>(
                                stream:   FirebaseFirestore.instance.collection('detaille').snapshots(),
                                builder:
                                    ( context,  snapshot) {
                                  ...
                                  return ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>modif_s(service: service)));
                                            });
                                          },
                                          child: Padding(
                                                  ...
                                                  child: ListTile(
                                                    ...
                                                    subtitle: Column(
                                                      children: [
                                                        ...
                                                        SizedBox(height: 5),
                                                        Container(alignment: Alignment.topLeft,child: Text("Stock : ${service['stock']}",style: TextStyle(color: Colors.black,fontSize: 15,),)),
                                                        ...
                                                        showDialog(context: context, builder: (context) {
                                                          return AlertDialog(
                                                            ...
                                                            actions: [
                                                              ElevatedButton(
                                                                onPressed: () {
                                                                  FirebaseFirestore.instance.collection('detaille').doc(service.id).delete();
